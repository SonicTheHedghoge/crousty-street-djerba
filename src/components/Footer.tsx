...
import { MapPin, Phone, Mail, CheckCircle2, ArrowRight, Heart } from "lucide-react";
...
export default function Footer({ currentLang }: FooterProps) {
  ...
  return (
    <footer className="bg-[#07090F] border-t border-rose-900/30 text-gray-400 text-sm relative pt-16 pb-24 sm:pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-500 to-amber-500 p-0.5 shadow-lg shadow-rose-500/20">
                <div className="w-full h-full bg-[#0A0D14] rounded-full flex items-center justify-center text-xl">
                  🦩
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 hover:border-rose-500 text-gray-300 hover:text-white flex items-center justify-center transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 hover:border-amber-500 text-gray-300 hover:text-white flex items-center justify-center transition-colors"
              >
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-2 text-xs font-light">
              ...
              <p className="text-amber-400 font-mono">+216 23 434 328</p>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#121722] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-rose-500"
                />
                <button
                  type="submit"
                  className="absolute right-1 top-1 bottom-1 px-3 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs"
                >
